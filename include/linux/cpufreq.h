...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_VLADUTIL)
extern struct cpufreq_governor cpufreq_gov_vladutil;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_vladutil)
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMURFUTIL_FLEX)
extern struct cpufreq_governor cpufreq_gov_smurfutil_flex;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_smurfutil_flex)
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMURFUTIL)
extern struct cpufreq_governor cpufreq_gov_smurfutil;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_smurfutil)
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_BLU_BALLS)
extern struct cpufreq_governor cpufreq_gov_blu_balls;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_blu_balls)
#endif
