...
TRACE_EVENT(sched_tune_filter,
	...
	TP_PROTO(int nrg_delta, int cap_delta, int nrg_gain, int cap_gain, int nrg_payoff, int region),

	TP_ARGS(nrg_delta, cap_delta, nrg_gain, cap_gain, nrg_payoff, region),
