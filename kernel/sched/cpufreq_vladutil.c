...
#define CONFIG_vladutil_DOWN_RATE_LIMIT		(60000)
#define CONFIG_vladutil_UP_RATE_LIMIT		(60000)
#define CONFIG_vladutil_UP_RATE_LIMIT_BC	(100000)
#define CONFIG_vladutil_DOWN_RATE_LIMIT_BC	(60000)
...
static int cpufreq_vladutil_gov_cb(struct cpufreq_policy *policy,
				unsigned int event)
{
	switch(event) {
...
static struct cpufreq_governor vladutil_gov = {
	.name = "vladutil",
	.governor = cpufreq_vladutil_gov_cb,
	.owner = THIS_MODULE,
};
