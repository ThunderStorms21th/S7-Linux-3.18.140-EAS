...
#define TARGET_LOAD_1_BIGC 			10
#define TARGET_LOAD_2_BIGC 			30

#define LATENCY_MULTIPLIER			(50000)
...
static int cpufreq_smurfutil_flex_gov_cb(struct cpufreq_policy *policy,
				unsigned int event)
{
	switch(event) {
...
static struct cpufreq_governor smurfutil_flex_gov = {
	.name = "smurfutil_flex",
	.governor = cpufreq_smurfutil_flex_gov_cb,
	.owner = THIS_MODULE,
};
