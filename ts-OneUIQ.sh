...
FUNC_BUILD_KERNEL()
{
	...
	cat $RDIR/arch/$ARCH/configs/$DEFCONFIG_Q >> $RDIR/arch/$ARCH/configs/tmp_defconfig
...
FUNC_BUILD_DTB()
{
	...
	case $MODEL in
	G930)
		DTSFILES="exynos8890-herolte_eur_open_q_04 exynos8890-herolte_eur_open_q_08
				exynos8890-herolte_eur_open_q_09 exynos8890-herolte_eur_open_q_10"
		;;
	G935)
		DTSFILES="exynos8890-hero2lte_eur_open_q_04 exynos8890-hero2lte_eur_open_q_08"
		;;
	*)
