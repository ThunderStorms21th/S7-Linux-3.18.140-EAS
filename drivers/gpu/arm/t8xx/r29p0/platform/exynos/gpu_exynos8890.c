...
/*	{754, 850000, 0, 96,  99, 2, 0, 1794000, 413000, 1586000, CPU_MAX},
	...
	{650, 800000, 0, 94,  97, 5, 0, 1794000, 413000, 1274000, 2080000},
	{600, 800000, 0, 78,  95, 9, 0, 1539000, 413000, 1274000, 1872000},
	{546, 800000, 0, 78,  95, 1, 0, 1144000, 413000, 1170000, 1664000},
	{419, 800000, 0, 78,  82, 1, 0, 1144000, 267000, 1066000, 1560000},
	{338, 800000, 0, 78,  82, 1, 0,  546000, 200000,  962000, 1456000},
	{260, 800000, 0, 78,  82, 1, 0,  421000, 160000,  858000, 1352000},
	{112, 800000, 0, 78,  80, 1, 0,  421000, 160000,  858000, 1248000},
};
...
static gpu_attribute gpu_config_attributes[GPU_CONFIG_LIST_END] = {
	...
	{GPU_GOVERNOR_INTERACTIVE_HIGHSPEED_DELAY, 1},	/* 0 */
	...
	{GPU_DVFS_TIME_INTERVAL, 5},		/* 5 */
	{GPU_DEFAULT_WAKEUP_LOCK, 1},
	{GPU_BUS_DEVFREQ, 0},
	{GPU_DYNAMIC_ABB, 0},
	{GPU_EARLY_CLK_GATING, 0},
	{GPU_DVS, 1},				/* 1 - on, 0 -off */
	{GPU_PERF_GATHERING, 0},
#ifdef CONFIG_MALI_SEC_HWCNT
	{GPU_HWCNT_PROFILE, 0},
	{GPU_HWCNT_GATHERING, 1},
	{GPU_HWCNT_POLLING_TIME, 90},		/* 90 */
	{GPU_HWCNT_UP_STEP, 3},			/* 3  */		
	{GPU_HWCNT_DOWN_STEP, 2},		/* 2  */
	{GPU_HWCNT_GPR, 1},			/* 1  */
...
#endif
	{GPU_RUNTIME_PM_DELAY_TIME, 50},	/* 50 */
	{GPU_DVFS_POLLING_TIME, 30},		/* 30 */
	{GPU_PMQOS_INT_DISABLE, 1},
	{GPU_PMQOS_MIF_MAX_CLOCK, 1539000},	/* 1539000 */
	{GPU_PMQOS_MIF_MAX_CLOCK_BASE, 650},	/* 650 */
	{GPU_CL_DVFS_START_BASE, 600},		/* 702 */
	{GPU_DEBUG_LEVEL, DVFS_WARNING},
	{GPU_TRACE_LEVEL, TRACE_ALL},
#ifdef CONFIG_MALI_DVFS_USER
	{GPU_UDVFS_ENABLE, 1},			/* 1 - on, 0 - off */
#endif
	{GPU_MO_MIN_CLOCK, 419},		/* 419 */
	{GPU_BOOST_EGL_MIN_LOCK, 1872000},	/* 1872000 */
};
